...
import 'package:infixedu/paymentGateway/RazorPay/razorpay_service.dart';
import 'package:infixedu/paymentGateway/paypal/paypal_payment.dart';
...
import 'package:infixedu/paymentGateway/stripe/stripe_payment.dart'
    as StripePage;
...
class _FeePaymentMainState extends State<FeePaymentMain> {
  ...
  Future callRazorPayService() async {
    await RazorpayServices().openRazorpay(
      ...
      userName: "",
      successListener: (PaymentResponse uniPaymentResponse) {
        /// here manage code for success payment. ///
        if (uniPaymentResponse.paymentStatus) {}
      },
      failureListener: (PaymentResponse uniPaymentResponse) {
