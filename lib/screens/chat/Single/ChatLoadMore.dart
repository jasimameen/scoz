...
import 'package:infixedu/utils/model/chat/ChatMessageOpenModel.dart';
...
class ChatLoadMore extends LoadingMoreBase<ChatMessage> {
  ...
  Future submitText({Map data, bool hasFile, FormData formData}) async {
    ...
    try {
      ...
      print("SUBMIT TEXT RESPONSE => ${response.statusCode}");
      if (response.statusCode == 200) {
        ...
        // Logger.debug(chatOpenController.lastConversationId.value);
