...
import 'package:infixedu/controller/chat_controller.dart';
import 'package:infixedu/controller/chat_open_controller.dart';
import 'package:infixedu/screens/chat/Single/ChatLoadMore.dart';
import 'package:infixedu/screens/chat/Single/ChatMessageWidget.dart';
import 'package:infixedu/screens/chat/FilePreview/ChatFilesPage.dart';
...
import 'package:infixedu/utils/model/chat/ChatGroup.dart';
import 'package:infixedu/utils/model/chat/ChatMessage.dart';
import 'package:infixedu/utils/model/chat/ChatUser.dart';
...
class _ChatOpenPageState extends State<ChatOpenPage> {
  ...
  void initState() {
    ...
    print(_chatOpenController.userId);
  ...
  onAvatarPress(BuildContext context) {
    final child = Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          crossAxisAlignment: chatMessage.fromId.toString() == currentUserId
              ? CrossAxisAlignment.end
              : CrossAxisAlignment.start,
          children: <Widget>[],
        ),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: chatMessage.fromId.toString() != currentUserId
                  ? CachedNetworkImage(
                      imageUrl:
                          "${AppConfig.domainName}/${chatMessage.fromUser.avatarUrl}",
                      imageBuilder: (context, imageProvider) => Container(
                        width: 25.w,
                        height: 25.h,
                        decoration: BoxDecoration(
