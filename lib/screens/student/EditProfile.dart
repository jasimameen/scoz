    ...
    if (data['data']['flag'] == true) {
      if (_file != null) {
        await getProfile().then((value) {
          Utils.saveStringValue("image", value.studentPhoto);
        });
      }
      setState(() {});
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              if (snapshot.hasError) {
                ...
                _firstNameCtrl.text = snapshot.data.firstName;
                _lastNameCtrl.text = snapshot.data.lastName;
                _addressCtrl.text = snapshot.data.currentAddress;
