...
class _StudentOtherDownloadsState extends State<StudentOtherDownloads> {
  ...
  Future<UploadedContentList> fetchOtherDownloads(dynamic id) async {
    final response = await http.get(Uri.parse(InfixApi.getStudentOtherDownloads(id)),headers: Utils.setHeader(_token.toString()));
