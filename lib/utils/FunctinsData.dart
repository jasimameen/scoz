...
import 'package:infixedu/screens/student/FeesScreen.dart';
    ...
    switch (rule) {
      case '1':
        if (zoom == '1') {
          route = MaterialPageRoute(
              builder: (context) => Home(admins, adminIcons, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        } else {
          route = MaterialPageRoute(
              builder: (context) => Home(admins2, adminIcons2, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        }
      ...
      case '2':
        if (zoom == '1') {
          route = MaterialPageRoute(
              builder: (context) =>
                  DashboardScreen(students, studentIcons, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        } else {
          route = MaterialPageRoute(
              builder: (context) =>
                  DashboardScreen(students2, studentIcons2, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        }
      ...
      case '3':
        if (zoom == '1') {
          route = MaterialPageRoute(
              builder: (context) => Home(parent, parentIcons, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        } else {
          route = MaterialPageRoute(
              builder: (context) => Home(parent2, parentIcons2, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        }
      ...
      case '4':
        if (zoom == '1') {
          route = MaterialPageRoute(
              builder: (context) =>
                  DashboardScreen(teachers, teachersIcons, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        } else {
          route = MaterialPageRoute(
              builder: (context) =>
                  DashboardScreen(teachers2, teachersIcons2, rule));
          // Navigator.pushReplacement(context, route);
          Navigator.of(context, rootNavigator: true)
              .pushAndRemoveUntil(route, (Route<dynamic> route) => false);
        }
