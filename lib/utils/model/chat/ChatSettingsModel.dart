...
ChatSettingsModel chatSettingsModelFromJson(String str) => ChatSettingsModel.fromJson(json.decode(str));

String chatSettingsModelToJson(ChatSettingsModel data) => json.encode(data.toJson());
...
class ChatSettingsModel {
    ...
    factory ChatSettingsModel.fromJson(Map<String, dynamic> json) => ChatSettingsModel(
        permissionSettings: PermissionSettings.fromJson(json["permission_settings"]),
        invitationSettings: InvitationSettings.fromJson(json["invitation_settings"]),
...
class ChatSettings {
    ...
    factory ChatSettings.fromJson(Map<String, dynamic> json) => ChatSettings(
        ...
        chatCanStudentChatWithAdminAccount: json["chat_can_student_chat_with_admin_account"],
        chatAdminCanChatWithoutInvitation: json["chat_admin_can_chat_without_invitation"],
        chatOpen: json["chat_open"],
    );

    Map<String, dynamic> toJson() => {
        "chat_can_teacher_chat_with_parents": chatCanTeacherChatWithParents,
        "chat_can_student_chat_with_admin_account": chatCanStudentChatWithAdminAccount,
        "chat_admin_can_chat_without_invitation": chatAdminCanChatWithoutInvitation,
        "chat_open": chatOpen,
    };
}
...
class InvitationSettings {
    ...
    factory InvitationSettings.fromJson(Map<String, dynamic> json) => InvitationSettings(
...
class PermissionSettings {
    ...
    factory PermissionSettings.fromJson(Map<String, dynamic> json) => PermissionSettings(
        chatCanUploadFile: json["chat_can_upload_file"],
        chatFileLimit: json["chat_file_limit"],
        chatCanMakeGroup: json["chat_can_make_group"],
        chatStaffOrTeacherCanBanStudent: json["chat_staff_or_teacher_can_ban_student"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "chat_staff_or_teacher_can_ban_student": chatStaffOrTeacherCanBanStudent,
