...
class ActiveOnlineExamRow extends StatelessWidget {
  ...
  Widget getExamStatusWidget(
      {BuildContext context, dynamic isRunning, dynamic isWaiting, dynamic isClosed}) {
  ...
  Widget getStatus(BuildContext context, dynamic status,dynamic isRunning, dynamic isClosed) {
    if (status == 1) {
      return Container(
