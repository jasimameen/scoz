...
class _ContentRowState extends State<ContentRow> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              widget.content.contentType == null
                                  ? 'not assigned'
                                  : getContentType(widget.content.contentType),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              getAvailableFor(widget.content),
                              style: Theme.of(context).textTheme.headline4,
                            ),
                          ],
                        ),
  ...
  String getAvailableFor(Content content) {
    if (content.availableForAdmin == 1 && content.availableForAllClasses == 1) {
      return "All Admins - All Class Students";
    } else if (content.availableForAdmin == 0 &&
        content.availableForAllClasses == 1) {
      return "All Class Students";
    } else if (content.availableForAdmin == 1 &&
        content.availableForAllClasses == 0) {
      return "All Admins";
    } else if (content.availableForAdmin == 1 &&
        content.availableForAllClasses == 0) {
      return "All Admins";
